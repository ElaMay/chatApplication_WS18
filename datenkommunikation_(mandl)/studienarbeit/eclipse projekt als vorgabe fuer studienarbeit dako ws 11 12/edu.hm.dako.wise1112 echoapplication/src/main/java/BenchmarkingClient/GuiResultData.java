...
/**
 * Klasse GuiResultData
 * 
 * Ergebnisdaten aus Lasttest, die ueber diese Klasse fuer eine Ausgabe
 * auf Terminal (Bidlschirm) bereitgestellt werden.
 * 
 * @author Mandl
 *
 */
public class GuiResultData {
